...
*/
    public static Object castFromObject(Object obj, Class<?> destType) throws ParseException{
        if (obj == null){
            return null;
        }
     ...
     */
    private static Object castFromString(String val, Class<?> destType) throws ParseException{
        ...
        if (val.equals("") || val.equals("null") || val.equals("undefined")){
        	...
        	//return java.util.Date.parse(val); //出错
